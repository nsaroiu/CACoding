...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearUsersUseCase(clearViewModel, (ClearUserDataAccessInterface) userDataAccessObject);
    ...
    private static ClearController createClearUsersUseCase(ClearViewModel clearViewModel, ClearUserDataAccessInterface userDataAccessObject) {
        ClearOutputBoundary clearOutputBoundary = new ClearPresenter(clearViewModel);

        ClearInputBoundary clearUsersUseCaseInteractor = new ClearInteractor(userDataAccessObject, clearOutputBoundary);
        return new ClearController(clearUsersUseCaseInteractor);
    }
